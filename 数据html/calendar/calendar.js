...
includeLinkStyle("calendar/fonts/style.css");
        ...
        dateT.setAttribute("start-date",getFullYear.toString()+(getMonth+1).toString()+getDate);
        dateT.setAttribute("start-end",getFullYear.toString()+(getMonth+1).toString()+getDate);
    ...
    function calendar(year,month){
        ...
        m_days=new Array(31,28+isLeapYear(getFullYear),31,30,31,30,31,31,30,31,30,31);
        ...
        var controller = {
           ...
           // 年历点击事件；
            clickEven : function(){
                ...
                for(var i =0; i<form.length; i++){
                    form[i].addEventListener("click",function(){
                        ...
                        var thisValue = this.childNodes[0].childNodes[0].nodeValue;
                        // dateYear.innerHTML = thisValue;
                        if(dateYear2){dateYear2.innerHTML = thisValue;}
                        dateT.setAttribute("start-date",thisValue+"0101");
                        dateT.setAttribute("start-end",thisValue+"1231");
                        getFullYear = thisValue;
                        calendar();
                    })
                }
            }(),
            ...
            clickEven1 : function(){
                ...
                for(var i = 0; i < dateConmonth.length; i++){
                    dateConmonth[i].addEventListener("click",function(){
                        var thisValue = this.childNodes[0].childNodes[0].nodeValue;
                        dateT.setAttribute("start-date",getFullYear+thisValue.toString()+"01");
                        dateT.setAttribute("start-end",getFullYear+thisValue.toString()+m_days[getMonth]);
                        getMonth = Number(thisValue-1);
                        calendar();
                    })
                ...
                for(var i = 0; i < weekTr.length; i++){
                    weekTr[i].onclick = function(event,n){
                        return function(){
                            ...
                            // dateMonth.innerHTML = getMonth+1;
                            // dateMonth2.innerHTML = getMonth+1;
                            dateT.setAttribute("start-date",getFullYear.toString()+(getMonth+1).toString()+first);
                            dateT.setAttribute("start-end",getFullYear.toString()+(getMonth+1).toString()+last);
                            if(n == 0 && firstday > 1){
                                dateMonth.innerHTML = getMonth;
                                dateT.setAttribute("start-date",getFullYear.toString()+getMonth.toString()+first);
                                dateT.setAttribute("start-end",getFullYear.toString()+(getMonth+1).toString()+last);
                            }
                            if(n > 3 && tail > 5){
                                dateMonth2.innerHTML = getMonth+2;
                                dateT.setAttribute("start-date",getFullYear.toString()+(getMonth+1).toString()+first);
                                dateT.setAttribute("start-end",getFullYear.toString()+(getMonth+2).toString()+last);
                            }
                            if(n > 3 && tail > 7){
                                dateMonth2.innerHTML = getMonth+2;
                                dateT.setAttribute("start-date",getFullYear.toString()+(getMonth+2).toString()+first);
                                dateT.setAttribute("start-end",getFullYear.toString()+(getMonth+2).toString()+last);
                            }
                            // console.info(n);
                            // console.info(tail);
            ...
            clickEven3 : function(){
                ...
                for(var i = 0; i < dateConDays.length; i++){
                    dateConDays[i].addEventListener("click",function(){
                        dateT.setAttribute("start-date",String(getFullYear)+String(getMonth)+getDate);
                        dateT.setAttribute("start-end",String(getFullYear)+String(getMonth)+getDate);
                    });
                };
